...
client_id = 'ExitScanner2'
broker = "mqtt.eclipseprojects.io"
port = 1883
pub_topic = 'polito_parking/exit/scanner2/info'
sub_topic = 'polito_parking/exit/scanner2/command'
    ...
    with open(path, 'r+') as file:
        ...
        if os.stat(path).st_size == 0:
            ...
            if not fields:  # Stop the loop if the file is empty
                ...
                exitScanner2.scan_plate(plate_license)  # Simulate random time intervals
